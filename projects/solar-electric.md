...
4/0 wires for 12V, 6Ga for solar. The no-name Amazon 1ft wires turned out to be
of poor quality. The connectors weren't clamped well and the cable heated up
under load. Once we supplemented them with 4/0 from O'reilly's many problems
went away: No more voltage dips at 60% SoC (State of Charge) that causes Victron
to shut off 110V supply and no more barely-touchable wires during charging
phases or not being able to start the generator at low SoC.
